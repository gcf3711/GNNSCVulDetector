...
def printResult(file, node_feature, edge_feature):
    ...
    nodeOutPath = "../../data_mainnet/reentrancy/graph_data/node/" + file
    edgeOutPath = "../../data_mainnet/reentrancy/graph_data/edge/" + file
...
#     print("edge_feature", edge_feature)
    ...
    inputFileDir = "../../mainnet_sample_remove_comment/"
