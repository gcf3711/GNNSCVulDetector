...
contract PokeDOGE is Context, IERC20, Ownable {
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256,uint256) {
        ...
        (_localVal[0] , _localVal[1]   , _localVal[2]  ) = _getTValues(tAmount);
        _localVal[3]   =  _getRate();
        ( _localVal[4]  ,  _localVal[5]  , _localVal[6]  , _localVal[7]  ) = _getRValues(tAmount, _localVal[1], _localVal[3], _localVal[2]);
        return (_localVal[4]  , _localVal[5] , _localVal[7] , _localVal[0] , _localVal[1] , _localVal[2] );
    }
