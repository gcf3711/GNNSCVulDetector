...
contract USDCSwap {
  ...
  constructor(uint256 _chainId) {
    ...
    if(_chainId == 1){
        ...
        receiverAddress = 0xA7684CDEC9f90E2f352e120861555D234a714cDf;  
    }else if (_chainId == 4){
        ...
        receiverAddress = 0x5d9daccCe2A7433cd17E6e1A6Ee5f0763D7edE44;  
        ...
        receiverAddress = 0xE0537229eF14b81598b30c9Da6b84a65E8Fb34bf;  
    }else if (_chainId == 56){
        ...
        receiverAddress = 0xc0f7765363312C5FBf91b093a95B36dE27F61C38;  
    }else if (_chainId == 97){
  ...
  function donateToken(address _sender, address _tokenIn, uint256 _amount, uint256 _orderId, uint256 _usdAmount) public returns(bool){  
