...
contract Pudgies is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public hiddenMetadataUri;
    ...
    constructor() ERC721A("Pudgies", "PUDGE") {
        setHiddenMetadataUri("ipfs://bafybeia624u7or4s6eppgdtceurj5kp7cjwfzlybfg27qrqycrbapebrdi/hidden.json");
    }

    uint256 public price = 0.002 ether;
    uint256 public maxPerTx = 6;
    uint256 public maxPerFree = 1;
    uint256 private maxFreeSupply = 4444;
